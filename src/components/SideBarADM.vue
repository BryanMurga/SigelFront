     ...
     <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
       ...
       <ul class="space-y-2 font-medium">
         <li class="md:mt-5 flex items-center">
           <a
             href="home-adm"
             :class="{ 'bg-gray-100 dark:bg-gray-700': selectedSection === 'home' }"
         ...
         <li class="md:mt-5 flex items-center">
           <a
             href="leads"
             :class="{ 'bg-gray-100 dark:bg-gray-700': selectedSection === 'leads' }"
             class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
         ...
         <li class="md:mt-5 flex items-center">
           <a
             href="asignaciones"
             :class="{ 'bg-gray-100 dark:bg-gray-700': selectedSection === 'asignaciones' }"
             class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
         ...
         <li class="md:mt-5 flex items-center">
           <a
             href="reasignaciones"
             :class="{ 'bg-gray-100 dark:bg-gray-700': selectedSection === 'reasignaciones' }"
             class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
