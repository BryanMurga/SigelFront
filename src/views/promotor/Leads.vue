<template>
  <DashboardLayout name="Listado de Leads">
    ...
    <div v-if="leads.length" class="flex-1 p-4">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            >
              ...
              <button
                data-modal-hide="verContacto"
                type="button"
                @click="navigateToRegisterContacto()"
            ...
            <form class="p-4 md:p-5">
              ...
              <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                  ...
                  <input
                    ...
                    id="price"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    v-model="inputEscuelaProcedencia"
                ...
                <div v-if="selectedCountry === 'Mexico'">
                  ...
                  >
                    <option
                      v-for="state in Object.keys(estadosMunicipios)"
                      :key="state"
                      :value="state"
                ...
                <div v-if="selectedCountry === 'Mexico' && selectedState">
                  <label
                    for="municipios"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >Selecciona una municipio</label
                  >
                  <select
                  ...
                  >
                    <option
                      v-for="municipio in estadosMunicipios[selectedState]"
                      :key="municipio"
                      :value="municipio"
                      :placeholder="selectedMunicipio"
                    >
              ...
              <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                  ...
                  >
                  <DatePicker
                    v-model="leads.FechaPrimerContacto"
                    :placeholder="inputFechaPrimerContacto"
                    class="input-field rounded-md"
                    :clearable="true"
                  />
                </div>
                ...
                <div>
                  ...
                  >
                    <option v-for="ps in PSeguimientos" :key="ps" :value="ps">
                      {{ ps }}
                    </option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  >
                    <option
                      v-for="carreras in CarreraInteres"
                      :key="carreras.Nombre"
                      :value="carreras.CarreraID"
                      required=""
                    >
                      {{ carreras.Nombre }}
                    </option>
                ...
                <div>
                  <label
                    for="estatus-inscripcion"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >Estatus de inscripción</label
                  >
                  <select
                    id="estatus-inscripcion"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-model="inputEstatusInscripcion"
                  >
                    <option
                      v-for="estatus in EstatusIncripcion"
                      :key="estatus"
                      :value="estatus"
                    >
                      {{ estatus }}
                ...
                <div>
                  ...
                  >
                    <option
                      v-for="semestre in SemestreIngreso"
                      :key="semestre"
                      :value="semestre"
                    >
                      {{ semestre }}
                ...
                <div>
                  ...
                  <input
                    ...
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-model="inputCiclo"
                    placeholder="Ingresa el ciclo 2022-1"
                    required=""
                  />
                </div>
                <!-- Campana -->
                <div>
                  ...
                  >
                    <option
                      v-for="campanas in Campanas"
                      :key="campanas.CampanaID"
                ...
                <div>
                  ...
                  >
                    <option
                      v-for="contacto in medioContactos"
                      :key="contacto.MedioID"
                      :value="contacto.MedioID"
                    >
                      {{ contacto.Nombre }}
                    </option>
                  </select>
                ...
                <div>
                  ...
                  >
                    <option
                      v-for="referido in tipoReferido"
                      :key="referido"
                      :value="referido"
                    >
                      {{ referido }}
                ...
                <div>
                  <label
                    for="donde-obtuvo-dato"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >Donde obtuvo el dato</label
                  >
                  <select
                    id="donde-obtuvo-dato"
              ...
              <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                  ...
                  >
                  <DatePicker
                    v-model="leads.FechaInscripcion"
                    :placeholder="inputFechaInscripcion"
                    class="input-field rounded-md"
                  />
                </div>
                <!--Carrera Inscripción-->
                <div>
                  <label
                    for="carrera-inscripcion"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >Carrera de Inscripción</label
                  >
                  <select
                    id="carrera-inscripcion"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    id="becaOfrecida"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    v-model="inputBecaOfrecida"
                    placeholder="Ingresa el valor de la Beca"
                    required=""
                  />
                </div>
              </div>
              ...
              <button
                @click="actualizarLead(leadParaGestionar, $event)"
                type="submit"
                data-modal-toggle="crud-modal"
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form @submit.prevent="guardarDatos">
              ...
              <div class="grid gap-6 mb-6 md:grid-cols-2 p-4">
                <div>
                  <label
                    for="escuela-procedencia"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >Escuela Procedencia</label
                  >
                  <input
                    v-model="updateLead.EscuelaProcedencia"
                    type="text"
                    id="escuela-procedencia"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div v-if="updateLead.NombrePais === 'Mexico'">
                  ...
                  >
                  <select
                    v-model="updateLead.NombreEstado"
                    id="states"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option
                ...
                >
                  ...
                  >
                  <select
                    v-model="updateLead.NombreCiudad"
                    id="municipios"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option
                      v-for="municipio in estadosMunicipios[
                        updateLead.NombreEstado
                      ]"
                      :key="municipio"
                      :value="municipio"
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.PSeguimiento"
                    id="ps-seguimiento"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.CarreraInteresID"
                    id="carrera-interes"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.EstatusInsc"
                    id="estatus-inscripcion"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.SemestreIngreso"
                    id="semestre-ingreso"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.CampanaID"
                    id="semestre-ingreso"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option selected>Escoge la campaña</option>
                    <option
                      v-for="camapana in Campanas"
                      :key="camapana"
                ...
                <div>
                  ...
                  >
                  <input
                    v-model="updateLead.AsetNameForm"
                    type="text"
                    id="asetform"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.IsOrganic"
                    id="isOrg"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option
                      v-for="isOrga in isOrganic"
                      :key="isOrga"
                      :value="isOrga"
                    >
                      {{ isOrga }}
                ...
                <div>
                  ...
                  >
                  <select
                    v-model="updateLead.MedioDeContactoID"
                    id="medio-contacto"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option
                      v-for="medio in medioContactos"
                      :key="medio"
                      :value="medio.MedioID"
                    >
                      {{ medio.Nombre }}
      ...
      <!-- Modal de filtrado -->
      <div
      class="mt-5 ml-40 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-center"
      >
        ...
        <div v-if="selectedFiltrado === 'Carrera'">
          ...
          >
            ...
            <option
              v-for="carrera in CarreraInteres"
              :key="carrera"
              :value="carrera.CarreraID"
            >
              {{ carrera.Nombre }}
        ...
        <div v-if="selectedFiltrado === 'IsOrganic'">
          ...
          >
            ...
            <option v-for="isO in isOrganic" :key="isO" :value="isO">
              {{ isO }}
            </option>
          </select>
        </div>
    ...
    <section>
      ...
      >
        <table
          ...
          class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400"
        >
        <thead class="text-xs uppercase dark:bg-sky-800 text-white sticky-header">
            <tr>
              <th scope="col" class="px-6 py-3">Seleccionar</th>
              <th scope="col" class="px-6 py-3">Id</th>
              <th scope="col" class="px-6 py-3">Nombre Completo</th>
              <th scope="col" class="place-items-center px-4 py-3">Teléfono</th>
              <th scope="col" class="px-6 py-3 text-center">
                Teléfono Secundario
              </th>
              <th scope="col" class="px-6 py-3">Correo Electrónico</th>
              <th scope="col" class="px-6 py-3">Correo Electrónico 2</th>
              <th scope="col" class="px-6 py-3">Gestionar</th>
              <th scope="col" class="px-6 py-3">Contacto</th>
              <th scope="col" class="px-6 py-3">Escuela Procedencia</th>
            ...
            >
              <td class="w-4 p-4">
                <div class="flex items-center">
                  <input
                    id="'checkbox-table-search-1' + lead.LeadID"
                    type="checkbox"
              ...
              <td class="px-6 py-4">
                <button
                  @click="GestionarLead(lead.LeadID)"
                  data-modal-target="crud-modal"
                  data-modal-toggle="crud-modal"
                  type="button"
                  class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-blue-800"
                >
                  Gestionar
                </button>
              </td>
      ...
      <br />
      <button
        v-show="hasSelectedLeads"
        type="button"
        data-modal-target="update-many"
        data-modal-toggle="update-many"
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      errLeads,
      errPromotores,
      actualizarLeadNotify,
      errorActualizarLeadNotify,
    };
  },
    ...
    filterList() {
      ...
      if (this.selectedFiltrado == "PSeguimiento" && this.subSelectedFiltrado) {
        return this.leads.filter((lead) => {
          const pSeguimiento =
            lead && lead.PSeguimiento ? lead.PSeguimiento : "";
          return pSeguimiento.includes(this.subSelectedFiltrado);
        });
      }

      if (
        this.selectedFiltrado == "Promotor Actual" &&
        this.subSelectedFiltrado
      ) {
        return this.leads.filter((lead) => {
          const promotorActualSelect =
            lead && lead.promotorActual ? lead.promotorActual : "";
          return promotorActualSelect === this.subSelectedFiltrado;
        });
      }

      if (
        this.selectedFiltrado == "Medio de Contacto" &&
        this.subSelectedFiltrado
      ) {
        return this.leads.filter((lead) => {
          const medioContactoSelect =
            lead && lead.MedioDeContactoID ? lead.MedioDeContactoID : "";
      ...
      if (this.selectedFiltrado == "Carrera" && this.subSelectedFiltrado) {
        return this.leads.filter((lead) => {
          const carreraSelect =
            lead && lead.CarreraInteresID ? lead.CarreraInteresID : "";
      ...
      if (this.selectedCategory == "Nombre") {
        return this.leads.filter((lead) => {
          const nombreCompleto =
            lead && lead.NombreCompleto ? lead.NombreCompleto : "";
      ...
      if (this.selectedCategory == "CorreoElectronico") {
        return this.leads.filter((lead) => {
          const correoElectronicoSearch =
            lead && lead.CorreoElectronico ? lead.CorreoElectronico : "";
          return correoElectronicoSearch
            .toLowerCase()
            .includes(this.input.toLowerCase());
        });
      }
      ...
      if (this.selectedCategory == "EscuelaProcedencia") {
        return this.leads.filter((lead) => {
          const escuelaProcedenciaSearch =
            lead && lead.EscuelaProcedencia ? lead.EscuelaProcedencia : "";
      ...
      if (this.selectedCategory == "Estado") {
        return this.leads.filter((lead) => {
          const estadoSearch =
            lead && lead.NombreEstado ? lead.NombreEstado : "";
      ...
      if (this.selectedCategory == "Ciudad") {
        return this.leads.filter((lead) => {
          const ciudadSearch =
            lead && lead.NombreCiudad ? lead.NombreCiudad : "";
  ...
  methods: {
    ...
    async loadLeads() {
      ...
      try {
        ...
        const response = await axios.get(
          "http://localhost:4000/promotores/leads",
          {
            params: {
    ...
    async GestionarLead(LeadID) {
      try {
        const response = await axios.get(
          `http://localhost:4000/leads/${LeadID}`
        );
        ...
        this.inputFechaNacimiento = lead.FechaNac
          ? lead.FechaNac.split("T")[0]
          : "";
        ...
        this.inputFechaPrimerContacto = lead.FechaPrimerContacto
          ? lead.FechaPrimerContacto.split("T")[0]
          : "";
        ...
        this.inputFechaInscripcion = lead.FechaInscripcion
          ? lead.FechaInscripcion.split("T")[0]
          : "";
      ...
      if (hayCambios) {
        try {
          const response = await axios.put(
            `http://localhost:4000/leads/update/${LeadID}`,
            {
              // Datos a actualizar
    ...
    hayCambiosEnDatos() {
      ...
      return (
        this.inputName !== this.LeadIndividual.NombreCompleto ||
        this.inputTelefono !== this.LeadIndividual.Telefono ||
        this.inputTelefono2 !== this.LeadIndividual.telefono2 ||
        this.inputCorreo !== this.LeadIndividual.CorreoElectronico ||
        this.inputCorreo2 !== this.LeadIndividual.CorreoElectronico2 ||
        this.leads.FechaNac !== this.LeadIndividual.FechaNac ||
        this.inputEscuelaProcedencia !==
          this.LeadIndividual.EscuelaProcedencia ||
        this.selectedCountry !== this.LeadIndividual.NombrePais ||
        this.selectedState !== this.LeadIndividual.NombreEstado ||
        this.selectedMunicipio !== this.LeadIndividual.NombreCiudad ||
        this.leads.FechaPrimerContacto !== null ||
        this.inputPSeguimiento !== this.LeadIndividual.PSeguimiento ||
        this.inputCarreraInteres !== this.LeadIndividual.CarreraInteresID ||
        this.inputGrado !== this.LeadIndividual.Grado ||
        this.inputPrograma !== this.LeadIndividual.Programa ||
        this.inputEstatusInscripcion !== this.LeadIndividual.EstatusInsc ||
        this.inputSemestreIngreso !== this.LeadIndividual.SemestreIngreso ||
        this.inputCiclo !== this.LeadIndividual.Ciclo ||
        this.inputCampana !== this.LeadIndividual.CampanaID ||
        this.inputAsetNameForm !== this.LeadIndividual.AsetNameForm ||
        this.inputIsOrganic !== this.LeadIndividual.IsOrganic ||
        this.inputMedioContacto !== this.LeadIndividual.MedioDeContactoID ||
        this.inputTipoReferido !== this.LeadIndividual.TipoReferido ||
        this.inputNombreReferido !== this.LeadIndividual.NombreReferido ||
        this.inputDondeObtuvoDato !== this.LeadIndividual.DondeObtDato ||
        this.leads.FechaInscripcion !== null ||
        this.inputCarreraInscripcion !==
          this.LeadIndividual.CarreraInscripcion ||
        this.inputBecaOfrecida !== this.LeadIndividual.BecaOfrecida
      );
    },
    ...
    async loadContactos(id) {
      ...
      console.log("Valor de id:", id);
      axios
        .get(`http://localhost:4000/leads/contacto/${id}`)
        .then((response) => {
    ...
    async loadEstadoMunicipio() {
      axios
        .get("/estados-municipios.json")
        .then((response) => {
          this.estadosMunicipios = response.data;
        })
        .catch((error) =>
          console.error("Error al obtener los estados y municipios:", error)
        );
    },
