        ...
        <div class="w-full max-w-md p-6">
          <form @submit.prevent="registerPromotor" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
              ...
              <input v-model="promotor.Passw" type="password" id="contrasena" placeholder="Contraseña" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
            </div>
            <div class="mb-6">
              <label class="block text-gray-700 text-sm font-bold mb-2" for="confirmarContrasena">
                Confirmar Contraseña
              </label>
              <input v-model="confirmarContrasena" type="password" id="confirmarContrasena" placeholder="Confirmar Contraseña" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
    ...
    methods: {
      async registerPromotor() {
        try {
          ...
          if (!Nombre || !Telefono || !Correo || !Passw || !this.validateNombre || !this.validateTelefono || !this.validateCorreo || Contrasena !== this.confirmarContrasena) {
