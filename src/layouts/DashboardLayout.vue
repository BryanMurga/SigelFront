...
<template>
    <!-- component -->
    <aside
        class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-[#1f2937] text-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
            <div class="mt-8 text-center">
                <img src="/logo.png" alt="" class="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28">
            ...
            <ul class="space-y-2 tracking-wide mt-8">
                ...
                <li v-if="isAdmin">
                    <SideBarLink href="asignaciones" :active="isLinkActive('/asignaciones')">
                        ...
                        <span class="group-hover:text-[#4fc4ae]">Asignar</span>
                    </SideBarLink>
                </li>
                <li v-if="isAdmin">
                    <SideBarLink href="reasignaciones" :active="isLinkActive('/reasignaciones')">
                        ...
                        <span class="group-hover:text-[#4fc4ae]">Reasignar</span>
                    </SideBarLink>
                </li>
                <li v-if="isAdmin">
                    <SideBarLink href="cargar-archivo" :active="isLinkActive('/cargar-archivo')">
                        ...
                        <span class="group-hover:text-[#4fc4ae]">Cargar base</span>
                    </SideBarLink>
                </li>
                ...
                <li v-if="isPromotor">
                    <a href="registrar-lead" class="px-4 py-3 flex items-center space-x-4 rounded-md group">
                        ...
                        <span class="group-hover:text-[#4fc4ae]">Registrar</span>
                    </a>
                </li>
                <li v-if="isPromotor">
                    <a href="alumno-promotor" class="px-4 py-3 flex items-center space-x-4 rounded-md group">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                            <path class=" group-hover:text-[#4fc4ae]" fill-rule="evenodd"
                        ...
                        <span class="group-hover:text-[#4fc4ae]">Inscritos</span>
                    </a>
                </li>
                ...
                <li v-if="isCoordinador">
                    <a href="alumno-coordinador" aria-label="dashboard"
                        class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-[#057a55]">
                        <svg class="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
                            <path
                                d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z"
                        ...
                        <span class="-mr-1 font-medium">Alumnos</span>
                    </a>
                </li>
                <li v-if="isCoordinador">
                    <a href="alumno-promotor" class="px-4 py-3 flex items-center space-x-4 rounded-md group">
    ...
    <div class="ml-auto lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
            <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
                <h5 hidden class="text-2xl text-gray-600 font-medium lg:block">{{ name }}</h5>
